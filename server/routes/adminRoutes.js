...
// ============================================================
// SUPPORT REQUESTS — admin görüntüleme + güncelleme
// ============================================================
router.get('/support-requests', supportController.getAllSupportRequests);
router.patch('/support-requests/:id', supportController.updateSupportRequestStatus);
