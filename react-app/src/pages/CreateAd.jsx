                        ...
                        <div className="space-y-6">
                            {adType === 'have' && (
                                <div className="space-y-3">
                                    <label className="block text-[10px] font-black text-stone-400 uppercase tracking-widest">GÖRSELLER * (en fazla 10)</label>
                                    <label className="block w-full h-[120px] md:h-[200px] rounded-2xl md:rounded-[2rem] border-2 border-dashed border-stone-200 bg-stone-50 hover:bg-stone-100 transition-all cursor-pointer flex flex-col items-center justify-center">
                                        ...
                                        <span className="text-[10px] text-stone-400 italic">PNG, JPG, en fazla 10 dosya</span>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <select value={form.location} onChange={(e) => upd('location', e.target.value)} className="w-full bg-stone-50 border border-stone-200 px-4 py-3 rounded-xl focus:border-stone-900 outline-none text-sm md:text-base">
                                        <option value="">— seçin —</option>
