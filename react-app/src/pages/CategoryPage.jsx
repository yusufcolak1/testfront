                                    ...
                                    <div className="flex flex-col gap-1.5">
                                        {options.map(opt => (
                                            <button
                                                ...
                                                className={`text-left px-4 py-2.5 rounded-xl font-serif italic text-sm transition-all border-2 ${filters[key] === opt ? 'bg-stone-900 border-stone-900 text-amber-400 font-bold shadow-md translate-x-1' : 'bg-stone-50 border-transparent text-stone-600 hover:bg-stone-100'}`}
                                            >
                                                {opt}
                                            </button>
                                        ))}
                ...
                <div className="container mx-auto px-6 py-12 max-w-7xl animate-in fade-in duration-700">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-8">
                        <div className="space-y-3 text-center md:text-left">
                            ...
                            <p className="text-stone-500 font-serif italic text-lg md:text-xl max-w-sm">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div className="bg-stone-50 px-6 md:px-10 py-4 md:py-5 rounded-[1.5rem] md:rounded-[2rem] border border-stone-100 shadow-sm flex items-center gap-3">
                                <span className="text-2xl md:text-3xl font-serif font-black text-stone-900">{pagination.total}</span>
                                <span className="text-[10px] font-black text-stone-500 tracking-widest uppercase">İLAN</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                {loading ? (
                    ...
                    <div className="flex flex-col items-center justify-center py-24 gap-4">
                        ...
                        <Link 
                            ...
                            className="bg-stone-900 text-white px-8 py-3 rounded-xl font-black text-[10px] tracking-widest uppercase"
                        >
                            İLK İLANI SEN VER
                        </Link>
                    </div>
                                    ...
                                    <div className="px-1 md:px-2 pb-1 md:pb-2 space-y-1.5 md:space-y-3">
                                        <div className="flex items-center justify-between">
                                            <div className="flex items-center gap-1 md:gap-2 min-w-0">
                                                ...
                                                <span className="text-[8px] md:text-[9px] font-black text-stone-500 tracking-widest uppercase italic truncate">@{userName.toLowerCase()}</span>
                                            </div>
