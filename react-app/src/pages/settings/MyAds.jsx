...
import { ArrowLeft, Package, Trash2, Edit2, Search, Zap } from 'lucide-react';
        ...
        (async () => {
            try {
                ...
                setAds((r.data || []).map((it) => ({
                    ...
                    image: it.images?.[0]?.imageUrl ? getFullImageUrl(it.images[0].imageUrl) : '',
                })));
                            ...
                            <div className="flex-1 flex flex-col justify-between py-1 min-w-0">
                                ...
                                <div className="flex items-center justify-between pt-2">
                                    ...
                                    <div className="flex gap-1.5">
                                        <button 
                                            onClick={() => navigate(`/ilan/${ad.id}/eslesmeler`)}
                                            title="Akıllı Eşleşmeler"
                                            className="p-2 bg-amber-50 text-amber-500 rounded-lg hover:text-white hover:bg-amber-500 transition-all shadow-sm flex items-center justify-center"
                                        >
