...
import { LayoutDashboard, Users, Package, Tag, RefreshCw, HelpCircle, BookOpen, Crown, CreditCard, Shield, Settings, Home, Headset } from 'lucide-react';
...
const items = [
    ...
    { to: '/admin/destek-talepleri', icon: Headset, label: 'Destek Talepleri' },
